...
$(document).ready(function () {
  ...
  $('#calendar').fullCalendar({
    ...
    eventLimit: true,
    events: [
      // Aquí puedes cargar eventos preexistentes desde una fuente de datos (ejemplo: JSON)
      // {title: 'Evento 1', start: '2022-05-01'},
      // {title: 'Evento 2', start: '2022-05-03', end: '2022-05-05'},
      // ...
      { title: 'Radiografia', start: '2023-05-25', end: '2023-05-25', color: '#FF0000' }
    ],
    dayClick: function (date, jsEvent, view) {
      // Mostrar el modal para agregar eventos
      $('#modalAgregarEvento').modal('show');
      // Asignar la fecha seleccionada al campo de fecha en el formulario
      $('#txtFecha').val(date.format());
    }
  });

  // Manejar el evento de guardar evento
